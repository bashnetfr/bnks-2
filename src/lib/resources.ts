// ================================================================
// EduFit Nepal — Curated Resource Hub Content
//
...
export const CURATED_RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    description:
      'Asian Development Bank — Japan Scholarship Program for postgraduate study at designated Asian universities, with strong engineering and development focus.',
    type: 'scholarship',
  ...
  // --- Competitions ---
  {
    ...
    type: 'competition',
    url: 'https://ku.edu.np/',
    eligibility: 'Students grades 9–12 and university, teams of 2–4',
    deadline: '2026-11-01',
  ...
  },
  {
    ...
    eligibility: 'Students grades 8–12 across Nepal, individual or team',
    deadline: '2026-10-15',
  ...
  {
    id: 'learn-khan-01',
    title: 'Khan Academy — Free Math & Science',
    description:
  ...
  },
  {
    ...
    eligibility: 'Students grades 1–10, schools and teachers',
  ...
  },
  {
    ...
    title: 'Coursera Financial Aid — Free Certificates',
    description:
  ...
  {
    id: 'dm-cdc-01',
    title: 'Curriculum Development Centre — E-Resources',
    description:
